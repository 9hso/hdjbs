      ...
      $accounts = json_decode(file_get_contents('accounts.json'),1);
			if(isset($update->message)){
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/TTTT0R",
                   'caption'=>'تمت البرمجه بواسطه (@TTTT0R) 💸',
...
لمراسه المطور - @TTTT0R",
                  'reply_markup'=>json_encode([
					...
					$bot->sendphoto([
							'chat_id'=>$chatId,
							'photo'=> "https://t.me/tytyty123321/66",
							 'caption'=>'البوت مدفوع 💲 و ليس مجاني 👁‍🗨
لشراء نسخه مراسلةة المطور 👁‍🗨',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'▫️| 『 رضـوش 🇮🇶☠️』','url'=>'t.me/TTTT0R']],
                          [['text'=>"▪️| قناه صيد المشتركين", 'url'=>"t.me/TTTT0R"]],
                      ]
                  ])
              ]);   
				}
